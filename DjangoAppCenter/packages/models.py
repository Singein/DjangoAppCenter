...
logger = logging.getLogger("mail_admins_info")
...
class Package(models.Model):
    ...
    name = models.CharField(verbose_name="package name")
    repository = models.CharField(verbose_name="repository", default="https://pypi.org/simple")
    enable = models.BooleanField(verbose_name="enable", default=True)
    version = models.CharField(verbose_name="version", default="0.0.1")
    old_version = models.CharField(verbose_name="old_version", default="0.0.1", editable=False)
    ...
    pip_version = models.CharField(verbose_name="pip version", choices=(("pip3", "pip3"), ("pip", "pip")),
                                   default="pip")
    ...
    def install(self):
        os.system(f"{self.pip_version} install -i {self.repository} {self.name}")
